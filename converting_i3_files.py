...
def main_icecube86(backend: str) -> None:
    ...
    converter: DataConverter = CONVERTER_CLASS[backend](
        [
            ...
            I3FeatureExtractorIceCubeDeepCore("SplitInIcePulses"),
            I3DeploymentExtractor(),
            #I3FeatureExtractorIceCube86("graphnet_deployment_multiclass_pid_neutrino_pred"),
            #I3TruthExtractor("test_pid_neutrino_pred"),
            I3TruthExtractor(),
        ],
        outdir,
    )
